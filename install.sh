...
alias ai-api='unset ANTHROPIC_BASE_URL && unset ANTHROPIC_AUTH_TOKEN && unset ANTHROPIC_DEFAULT_HAIKU_MODEL && unset ANTHROPIC_DEFAULT_SONNET_MODEL && unset ANTHROPIC_DEFAULT_OPUS_MODEL && claude --dangerously-skip-permissions'
